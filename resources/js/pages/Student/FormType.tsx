      ...
      <div className="min-h-screen flex flex-col bg-white text-gray-900">
        ...
        <main className="flex-grow flex items-center justify-center bg-gradient-to-br from-[#800000] to-[#FFD700] p-3">
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-6 max-w-2xl w-full text-center">
            <div className="mb-10">
              <p className="text-lg text-gray-600 mt-3">Select your Form type below</p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <span className="text-xl">Student Form</span>
              </Link>

              <Link
                href={route('teacher.admission.form')}
              ...
              >
                ...
                <span className="text-xl">Teacher Form</span>
              </Link>
            </div>
          </div>
        </main>
