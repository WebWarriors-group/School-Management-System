...
import StudyMaterialIndex from '../studyMaterial/studyMaterialIndex';
...
export default function StudentDashboard() {
  ...
  const category = usePage().props.category as string;
  const materials = usePage().props.materials as [];
      ...
      <div className="flex min-h-screen bg-gray-100">
        ...
        <aside className="bg-white rounded-lg shadow p-4 w-full lg:w-64">
          ...
          <StudentSidebar />
            ...
            <StudyMaterialIndex category={category} materials={materials} />
      </div>
    </AppLayout>
  );
}
