  ...
  return (
    <div className="fixed inset-0 bg-gray-300 bg-opacity-50 flex items-center justify-center z-50 p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                {isEditing ? (
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={!!editData?.receiving_any_grade_5_scholarship}
              ...
              <div className="flex items-center justify-between">
                ...
                {isEditing ? (
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={!!editData?.receiving_any_samurdhi_aswesuma}
              ...
              <div className="flex items-center justify-between">
                ...
                {isEditing ? (
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={!!editData?.receiving_any_scholarship}
            ...
            <div>
              ...
              {isEditing ? (
                <input
                  type="date"
                  value={
                    editData?.admission_date ? new Date(editData.admission_date).toISOString().split("T")[0] : ""
                  }
                  onChange={(e) => handleChange("admission_date", e.target.value)}
                  className="w-full md:w-1/2 px-3 py-2 border rounded-lg mt-1"
                />
              ) : displayStudent.admission_date ? (
                <p className="font-medium">{new Date(displayStudent.admission_date).toLocaleDateString("en-GB")}</p>
              ) : (
      ...
      <StudentPersonalView
        ...
        onClose={() => setPersonalIsModalOpen(false)}
      />
