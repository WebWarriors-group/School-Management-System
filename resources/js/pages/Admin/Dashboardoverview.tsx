...
import { faUsers ,faFileLines,faBullhorn} from '@fortawesome/free-solid-svg-icons';
...
const StatsOverview: React.FC = () => {
    ...
    return (
        <AppLayout>
            <header className="sticky top-1 flex w-full items-center border-b bg-gray-100 p-4 shadow-sm">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button className="ml-5 h-12 w-37 rounded-4xl rounded-md border-4 border-white bg-[#4B0000] to-purple-800 px-4 py-1 text-[16px] text-white shadow-md hover:cursor-pointer focus:ring-2 focus:ring-green-400">
                            Quick Adding
                        </Button>
                    </DropdownMenuTrigger>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-10 border-2 mt-10 w-150 ml-10 h-70   ">
           

                    <div  className="relative mt-8 ml-5 h-55 w-60 border bg-white p-4 shadow-sm transition hover:shadow-md bg-purple-100 ">
                        {/* Colored square icon */}
                        <div
                            className={`bg-[#4B0000] absolute top-[-2px] left-[0px] flex h-15 w-20 items-center justify-center text-white shadow-lg`}
                        >
                            <span className="text-lg"><FontAwesomeIcon icon={faFileLines} className="text-4xl text-white" /></span>
                        </div>
                        ...
                        <div className="mt-[-40px] ml-20 pt-8">
                            ...
                            <Button className="mt-1 h-10 w-34 ml-[-3px]   bg-[#4B0000] px-4  text-[16px] text-white shadow-md hover:cursor-pointer focus:ring-2 focus:ring-green-400">
                            +Generate
                        </Button>
                    ...
                    <div  className="relative mt-8 ml-60 h-55 w-60 border bg-white p-4 shadow-sm transition hover:shadow-md ">
                        ...
                        <div
                            className={`bg-[#4B0000] absolute top-[-2px] left-[0px] flex h-15 w-20 items-center justify-center text-white shadow-lg`}
                        >
                            <span className="text-lg"><FontAwesomeIcon icon={faBullhorn} className="text-4xl text-white" /></span>
                        </div>
