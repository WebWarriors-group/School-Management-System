...
class QualificationFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'present_class' => $this->faker->randomElement(['Grade 1', 'Grade 2', 'Grade 3', 'Grade 4']),
            'present_grade' => $this->faker->randomElement(['A', 'B', 'C', 'D']),
            'appointment_date_for_current_class' => $this->faker->date(),
            'appointment_date_for_current_grade' => $this->faker->date(),
            'current_appointment_service_medium' => $this->faker->randomElement(['Online', 'In-person']),
